...
void main_things(ProgramState *program_state)
{
	...
	{
		send_message(program_state->is_lora_connected, "MID RUN RESET");
...
int main()
{
	...
	send_message(program_state.is_lora_connected, "BOOT. CONNECTED TO LORAWAN");
